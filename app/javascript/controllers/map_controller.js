        ...
        <div class="mp-container">
          ...
          <div class="mp-body">
            ...
            <div class="mp-actions">
              ${button_link ? `<a class="mp-link" href="${button_link}" target="_blank" rel="noopener">+ d'informations</a>` : `<div class="mp-link"></div>`}
              <a class="mp-primary" href="${gmaps}" target="_blank" rel="noopener">y aller ! →</a>
            </div>
            <div class="mp-vote-container">
              <span class="mp-vote-label">Donnez-nous votre avis :</span>
    ...
    <div class="sidebar-card sidebar-card--mobile">
      <div class="mp-container">
        ...
        <div class="mp-actions mp-actions--top">
          ${button_link ? `<a class="mp-link" href="${button_link}" target="_blank" rel="noopener">+ d'informations</a>` : ""}
          <a class="mp-primary" href="${gmaps}" target="_blank" rel="noopener">y aller ! →</a>
        </div>
        <!-- 3) Images (peek + snap) -->
        <div class="mp-header">
